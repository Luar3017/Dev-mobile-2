...
public class FragmentTarefas extends Fragment {
    ...
    public static FragmentTarefas newInstance(String param1, String param2) {
        FragmentTarefas fragment = new FragmentTarefas();
